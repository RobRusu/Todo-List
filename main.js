...
/***/ "./src/deleteProjectTasks.js":
/*!***********************************!*\
  !*** ./src/deleteProjectTasks.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   deleteProjectTasks: () => (/* binding */ deleteProjectTasks)\n/* harmony export */ });\n/* harmony import */ var _parseLocalData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parseLocalData */ \"./src/parseLocalData.js\");\n\n\nfunction deleteProjectTasks(){\n  const projectNames = document.querySelectorAll('.projectName');\n  for (let i = 0; i < _parseLocalData__WEBPACK_IMPORTED_MODULE_0__.tasks.length; i++){\n    if (_parseLocalData__WEBPACK_IMPORTED_MODULE_0__.tasks[i].project === projectNames[this.dataset.position].textContent){\n      const removeItem = `${_parseLocalData__WEBPACK_IMPORTED_MODULE_0__.tasks[i].title}-${_parseLocalData__WEBPACK_IMPORTED_MODULE_0__.tasks[i].description}`;\n      window.localStorage.removeItem(removeItem);\n    } else {\n      continue;\n    }\n  }\n}\n\n//# sourceURL=webpack://todo-list/./src/deleteProjectTasks.js?");
